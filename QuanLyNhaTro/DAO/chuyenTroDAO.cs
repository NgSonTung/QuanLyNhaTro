...
namespace QuanLyNhaTro.DAO
{
    public class chuyenTroDAO
    {
        ...
        {
            string sql = "select SV.maSinhVien, SV.name from sinhVien SV, hopDong HD, thanhToan TT where SV.maSinhVien = HD.maSinhVien and HD.maThanhToan = TT.maThanhToan and TT.maNhaTro =" + id;
