...
namespace QuanLyNhaTro.DAO
{
    public class countDAO
    {
        ...
        {
            string sql = "select HD.soSinhVien from hopDong HD, thanhToan TT, nhaTro NT where HD.maThanhToan = TT.maThanhToan and HD.soSinhVien >= 0 and TT.maNhaTro = NT.maNhaTro and TT.status = 0 and TT.maNhaTro = " + maNhaTro;
